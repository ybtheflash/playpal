...
<body class="text-white">
    ...
    <div class="fixed top-0 left-0 flex items-center justify-center h-full w-full bg-blur" style="z-index: 50;">
        <div class="w-full max-w-lg p-8">
            <h2 class="text-2xl font-semibold mb-4 text-center">Manage Members</h2>
            ...
            <tr>
                ...
                <th>E-mail</th>
                <th>Mobile</th>
                <th style="padding-right:10px;">Regisration</th>
                <th>Issued?</th>
            </tr>';
                    while ($row = $result->fetch_assoc()) {
                        echo '<tr>
                <td style="padding-right:10px;">' . $row['id'] . '</td>
                <td style="padding-right:10px;">' . $row['name'] . '</td>
                <td style="padding-right:20px;"> <a href = "mailto: ' . $row['email'] . '"><button class="bg-yellow-600 text-white text-sm font-semibold py-2 px-4 rounded-md hover:bg-indigo-700 transition duration-200">Mail</button></a></td>
                <td style="padding-right:30px;">' . $row['mob'] . '</td>
                <td style="padding-right:10px;">' . $row['reg_at'] . '</td>
                ...
                <!-- <button type="submit" name="repgen" class="bg-indigo-600 text-white text-sm font-semibold py-2 px-4 rounded-md hover:bg-indigo-700 transition duration-200">Generate</button> -->
            </form>
        </div>
    </div>
