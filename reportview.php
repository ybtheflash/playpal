...
<body class="text-white">
    ...
    <div class="fixed top-0 left-0 flex items-center justify-center h-full w-full bg-blur" style="z-index: 50;">
        <div class="w-full max-w-lg p-8">
            <h2 class="text-2xl font-semibold mb-4 text-center">View Report</h2>
            <iframe src="partials/report.pdf" style="width: 100%; height: 600px;">
                This browser does not support PDFs. Please download the PDF to view it:
                <a href="partials/report.pdf">Download Report</a>
            </iframe>
        </div>
    </div>
    ...
    <script>
        var pdfPath = "partials/report.pdf";

        var options = {
            height: "400px",
            width: "800px", // Adjust the height as needed
            pdfOpenParams: {
                view: "FitH", // Fit the PDF width to the window
                pagemode: "fullscreen", // Disable bookmarks and thumbnails
                scrollbar: "1", // Show horizontal scrollbar
            },
        };
