...
<body class="text-white">
    ...
    <div class="fixed top-0 left-0 flex items-center justify-center h-full w-full bg-blur" style="z-index: 50;">
        <div class="w-full max-w-lg p-8">
            <h2 class="text-2xl font-semibold mb-4 text-center">Order Disc</h2>
            <form action="" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="firstName" name="newname" class="w-full p-2 border rounded-md text-black" placeholder="Enter Disc Name">
                </div>
                <div class="mb-4">
                    <label for="lastName" class="text-sm block font-medium">Author</label>
                    <input type="tel" id="lastName" name="newmob" class="w-full p-2 border rounded-md text-black" placeholder="Enter Author Name">
                </div>
                <button type="submit" name="paynxt" class="bg-indigo-600 text-white text-sm font-semibold py-2 px-4 rounded-md hover:bg-indigo-700 transition duration-200">Proceed to Pay</button>
            </form>
        </div>
    </div>
